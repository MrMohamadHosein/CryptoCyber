package ir.MrMohamadHosein.CryptoCyber.features.coinActivity
...
import ir.MrMohamadHosein.CryptoCyber.R
import ir.MrMohamadHosein.CryptoCyber.apiManager.*
import ir.MrMohamadHosein.CryptoCyber.apiManager.model.ChartData
...
import ir.MrMohamadHosein.CryptoCyber.databinding.ActivityCoinBinding
...
class CoinActivity : AppCompatActivity() {
    ...
    private fun initChartUi() {
        ...
        if (dataThisCoin.coinInfo.fullName == "BUSD") {
            ...
            Log.v("dataCoin HANGEPCT24HOUR" , dataThisCoin.rAW.uSD.cHANGEPCT24HOUR.toString())
